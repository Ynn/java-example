...
public class Test {
	...
	public static void testCapteurs(Collection<IDevice> capteurs) {
		for (IDevice capteur : capteurs) {
			System.out.println("--------------");
	...
	public static void afficherCapteur(IDevice c) {
	...
	public static void main(String[] args) {
		...
		Collection<IDevice> capteurs = new ArrayList<>();
